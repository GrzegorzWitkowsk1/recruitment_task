import { categories, producersOptions, productAttributesOptions } from '@/config';
import {z} from 'zod';

const producerOptions = Object.keys(producersOptions) as [keyof typeof producersOptions, ...(keyof typeof producersOptions)[]]
const categoryOptions = Object.keys(categories) as [keyof typeof categories, ...(keyof typeof categories)[]]
const productAttributes = Object.keys(productAttributesOptions) as [keyof typeof productAttributesOptions, ...(keyof typeof productAttributesOptions)[]]
const currencyOptions = Object.keys(categories) as [keyof typeof categories, ...(keyof typeof categories)[]]

const generalSchema = z.object({
  productName: z.string().min(3, "Nazwa musi być dłuższa niż 3 znaki"),
  productSku: z.string().min(1, "SKU jest wymagane").max(24, "SKU nie może być dłuższe niż 24 znaki").regex(/^[a-zA-Z0-9]+$/, "Tylko litery i cyfry"),
